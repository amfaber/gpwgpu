...
fn internal_parse_shaders(input: TokenStream, prefix: proc_macro2::TokenStream, is_static: bool) -> TokenStream{
    let ProcessorAndDir { vis, processor, dir } = parse_macro_input!(input as ProcessorAndDir);
